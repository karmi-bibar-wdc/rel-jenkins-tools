                    ...
                    if d.endswith(execRow[12]):
                        for d2 in os.listdir(os.path.join(cycleDumpFolder,d)):
                            for d3 in os.listdir(os.path.join(cycleDumpFolder,d,d2)):
                                if 'PSA' in str(execRow[18]).split("\\")[-1].split(".")[0]:
                                    for d4 in os.listdir(os.path.join(cycleDumpFolder,d,d2,d3)):
                                        logPath = os.path.join(cycleDumpFolder,d,d2,d3,d4)  # full path to DC
                                        break
                                else:
